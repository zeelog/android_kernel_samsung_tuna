...
#define OMAP4460_VDD_MPU_OPP75_UV		1075000
#define OMAP4460_VDD_MPU_OPP100_UV		1150000
#define OMAP4460_VDD_MPU_OPPTURBO_UV		1250000
#define OMAP4460_VDD_MPU_OPPNITRO_UV		1340000
#define OMAP4460_VDD_MPU_OPPNITROS_UV		1360000
#define OMAP4460_VDD_MPU_OPPNITROSB_UV		1380000
#define OMAP4460_VDD_MPU_OPPUBER_UV		1400000
#define OMAP4460_VDD_MPU_OPPFIRE_UV		1420000
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
#ifdef CONFIG_OMAP4460_OVERCLOCKING
	/* NOTE: tuna and probably others don't want to play nicely with OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, work around that for now */
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP50_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0, 0, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP75_UV, 75000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0, 0, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	...
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITROS_UV, 0, 0, 2245, 2062, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITROSB_UV, 0, 0, 2484, 2276, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPUBER_UV, 0, 0, 2708, 2476, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPFIRE_UV, 0, 0, 2920, 2666, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0, 0, 0),
#elif defined(CONFIG_OMAP_SMARTREFLEX_CUSTOM_SENSOR)
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP50_UV, 10000, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0, 0, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0, 0, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPTURBO_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0, 0, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0, 0, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
#ifdef CONFIG_OMAP4460_OVERCLOCKING
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITROS_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
#endif
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPNITROSB_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
#ifdef CONFIG_OMAP4460_OVERCLOCKING
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPUBER_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4460_VDD_MPU_OPPFIRE_UV, .dep_vdd_volt = OMAP4460_VDD_CORE_OPP100_UV},
#endif
};
